...
{{- define "bjw-s.common.lib.pod.field.containers" -}}
  ...
  {{- range $key, $containerValues := $enabledContainers -}}
    ...
    {{- $containerObject := (include "bjw-s.common.lib.container.valuesToObject" (dict "rootContext" $rootContext "controllerObject" $componentObject "containerType" "default" "id" $key "values" $containerValues)) | fromYaml -}}
